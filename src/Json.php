...
class Json
{
    ...
    public const HTTP_MIME = 'application/json';
...
{
    public const LAST_JSON_ERROR = [];
    public const KEY_ALREADY_EXISTS = [
        'message' => '',
        'code' => 123
    ];

    public const ERROR_MESSAGE = 'Invalid Json Provided! Error Message: ';
